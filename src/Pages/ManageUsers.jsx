...
const ManageUsers = () => {
    ...
    const getAllUserData = () => {
        const url = "https://white-bit-back-endnew.vercel.app/api/alluserdata";
        axios
            .get(url)
            .then((response) => {
...
// };
    ...
    const adminAproveEmailSand = async (email) => {
        ...
        fetch('https://white-bit-back-endnew.vercel.app/api/adminAproveEmailSand', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
    ...
    const Verify = (id) => { 
            const url = `https://white-bit-back-endnew.vercel.app/api/UserVerify/${id}`;
            axios.patch(url)
                .then((response) => {
    ...
    return (
        <>
            <div className="w-full h-max px-6 py-10 flex flex-col gap-2 phone:gap-8 bg-[#f9fbfd] text-[rgb(87,89,98)]">
                <p className="text-[27px] font-semibold">Whitebitcrypfield users list</p>
